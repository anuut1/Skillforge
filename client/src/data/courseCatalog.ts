...
export const COURSES_CATALOG: CourseCatalogItem[] = [
  {
    ...
    "lectures": [
      {
        "id": "aws-l1",
        "title": "Cloud Concepts, Shared Responsibility & Global Infrastructure",
        "duration": 25
      },
      {
        "id": "aws-l2",
      ...
      {
        "id": "aws-l3",
        "title": "Elastic Compute Cloud (EC2) & Auto Scaling Groups",
        "duration": 50
      },
      {
        "id": "aws-l4",
        "title": "Amazon S3 Storage Classes, Lifecycle Rules & Encryption",
        "duration": 45
      },
      {
        "id": "aws-l5",
        "title": "Virtual Private Cloud (VPC) Subnets, Route Tables & Security Groups",
        "duration": 60
      },
      {
        "id": "aws-l6",
        "title": "Monitoring & Auditing with CloudWatch & CloudTrail",
        "duration": 35
      }
    ]
  },
  {
    ...
    "lectures": [
      ...
      {
        "id": "awsp-l2",
        "title": "AWS Billing, Budgets, and Cost Allocation Tags",
        "duration": 35
      },
      {
        "id": "awsp-l3",
        "title": "Database Offerings: RDS vs DynamoDB vs Aurora",
        "duration": 45
      },
      {
        "id": "awsp-l4",
        "title": "Application Integration: SQS, SNS, and EventBridge",
        "duration": 40
      },
      {
        "id": "awsp-l5",
        "title": "Exam Readiness & High-Probability Scenario Walkthroughs",
        "duration": 60
      }
    ]
  },
  {
    ...
    "lectures": [
      {
        "id": "az-l1",
        "title": "Azure Architectural Components: Regions, Geographies & Resource Groups",
        "duration": 30
      },
      {
        "id": "az-l2",
        "title": "Azure Compute: VMs, App Services, and Azure Container Instances",
        "duration": 45
      },
      {
        "id": "az-l3",
        "title": "Azure Virtual Networks, VPN Gateways & ExpressRoute",
        "duration": 40
      },
      {
        "id": "az-l4",
        "title": "Security & Identity: Microsoft Entra ID & Zero Trust Architecture",
        "duration": 45
      },
      {
        "id": "az-l5",
        "title": "Governance, Azure Policy & Cost Management",
        "duration": 30
      }
    ]
  },
  {
    ...
    "lectures": [
      {
        "id": "gcp-l1",
        "title": "Introduction to Google Cloud Platform & Resource Hierarchy",
        "duration": 25
      },
      {
        "id": "gcp-l2",
        "title": "Compute Options: Compute Engine, Cloud Run & App Engine",
        "duration": 45
      },
      {
        "id": "gcp-l3",
        "title": "Containers and Google Kubernetes Engine (GKE)",
        "duration": 50
      },
      {
        "id": "gcp-l4",
        "title": "Cloud Storage & Cloud SQL Database Persistence",
        "duration": 40
      },
      {
        "id": "gcp-l5",
        "title": "BigQuery Big Data & IAM Access Control",
        "duration": 40
      }
    ]
  },
  {
    ...
    "lectures": [
      {
        "id": "dk-l1",
        "title": "Containerization vs Virtual Machines: Namespaces & cgroups",
        "duration": 30
      },
      {
        "id": "dk-l2",
      ...
      {
        "id": "dk-l3",
        "title": "Docker Networking: Bridge, Host, and Overlay Networks",
        "duration": 35
      },
      {
        "id": "dk-l4",
      ...
      {
        "id": "dk-l5",
        "title": "Image Vulnerability Scanning and Container Registry Security",
        "duration": 30
      }
    ]
  },
  {
    ...
    "lectures": [
      {
        "id": "k8s-l1",
        "title": "K8s Control Plane & Worker Node Internal Architecture",
        "duration": 40
      },
      {
        "id": "k8s-l2",
        "title": "Pods, ReplicaSets & Zero-Downtime Rolling Deployments",
        "duration": 50
      },
      {
        "id": "k8s-l3",
        "title": "ClusterIP, NodePort, and LoadBalancer Services",
        "duration": 45
      },
      {
        "id": "k8s-l4",
        "title": "Ingress NGINX & TLS Certificate Termination",
        "duration": 45
      },
      {
        "id": "k8s-l5",
        "title": "Storage Management: PV, PVC, and CSI StorageClasses",
        "duration": 50
      },
      {
        "id": "k8s-l6",
        "title": "Helm Package Management & Troubleshooting CrashLoopBackOff",
        "duration": 55
      }
    ]
  },
  {
    ...
    "lectures": [
      {
        "id": "fs-l1",
        "title": "Modern Full-Stack Architecture & Client-Server Contracts",
        "duration": 35
      },
      {
        "id": "fs-l2",
        "title": "State Management, Hooks & Responsive UI with React & Tailwind",
        "duration": 55
      },
      {
        "id": "fs-l3",
        "title": "Express.js Middleware Pipeline, Routing & Error Handling",
        "duration": 45
      },
      {
        "id": "fs-l4",
        "title": "Relational Modeling with PostgreSQL and Prisma ORM",
        "duration": 50
      },
      {
        "id": "fs-l5",
        "title": "Stateless Authentication with Access & Refresh JWT Tokens",
        "duration": 40
      },
      {
        "id": "fs-l6",
        "title": "Deploying Production Full-Stack Apps to Cloud Platforms",
        "duration": 45
      }
    ]
  },
  {
    ...
    "lectures": [
      {
        "id": "rc-l1",
        "title": "React 19 Core: Compiler, use() hook, and Server Actions",
        "duration": 45
      },
      {
        "id": "rc-l2",
        "title": "Next.js 15 App Router: Layouts, Templates & Route Handlers",
        "duration": 50
      },
      {
        "id": "rc-l3",
        "title": "Client vs Server Components: Data Fetching and Streaming SSR",
        "duration": 55
      },
      {
        "id": "rc-l4",
        "title": "Optimistic UI Updates and Form Validation with Zod",
        "duration": 40
      },
      {
        "id": "rc-l5",
        "title": "Performance Tuning: Core Web Vitals, Dynamic Imports & Caching",
        "duration": 45
      }
    ]
  },
  {
    ...
    "lectures": [
      {
        "id": "sb-l1",
        "title": "Spring Core: Inversion of Control & Dependency Injection Internals",
        "duration": 40
      },
      {
        "id": "sb-l2",
        "title": "Spring Data JPA: Entity Mappings, Transactions, and N+1 Fixes",
        "duration": 50
      },
      {
        "id": "sb-l3",
        "title": "Spring Security 6: OAuth2 Resource Server & JWT Validation",
        "duration": 45
      },
      {
        "id": "sb-l4",
        "title": "Event-Driven Microservices with Apache Kafka & Avro Schemas",
        "duration": 60
      },
      {
        "id": "sb-l5",
        "title": "API Gateway, Service Registry & Resilience4j Circuit Breakers",
        "duration": 55
      },
      {
        "id": "sb-l6",
        "title": "Observability: Distributed Tracing with Micrometer & Zipkin",
        "duration": 45
      }
    ]
  },
  {
    ...
    "lectures": [
      {
        "id": "rest-l1",
        "title": "REST Architectural Constraints & Proper Resource URI Modeling",
        "duration": 35
      },
      {
        "id": "rest-l2",
        "title": "Idempotency, HTTP Methods & Granular Status Code Semantics",
        "duration": 40
      },
      {
        "id": "rest-l3",
        "title": "Cursor-Based Pagination, Filtering & OpenAPI Documentation",
        "duration": 45
      },
      {
        "id": "rest-l4",
        "title": "OWASP API Top 10: Defending Against BOLA, BFLA & Injection",
        "duration": 50
      }
    ]
  },
  {
    ...
    "lectures": [
      {
        "id": "jv-l1",
        "title": "Object-Oriented Design Principles: SOLID in Practice",
        "duration": 45
      },
      {
        "id": "jv-l2",
        "title": "Java Collections Internals: HashMap Collisions & Red-Black Trees",
        "duration": 50
      },
      {
        "id": "jv-l3",
        "title": "Generics, Reflection & Functional Interfaces with Streams",
        "duration": 45
      },
      {
        "id": "jv-l4",
        "title": "Concurrency & Multithreading: Virtual Threads & Executors",
        "duration": 60
      },
      {
        "id": "jv-l5",
        "title": "JVM Memory Architecture: Heap, Stack & G1 Garbage Collector",
        "duration": 55
      }
    ]
  },
  {
    ...
    "lectures": [
      {
        "id": "py-l1",
        "title": "Idiomatic Python, Comprehensions & Memory Model",
        "duration": 35
      },
      {
        "id": "py-l2",
        "title": "Generators, Iterators, and Custom Decorators",
        "duration": 45
      },
      {
        "id": "py-l3",
        "title": "Asynchronous Programming with asyncio & Coroutines",
        "duration": 50
      },
      {
        "id": "py-l4",
        "title": "Object-Oriented Python: Dunder Methods and Metaclasses",
        "duration": 45
      },
      {
        "id": "py-l5",
        "title": "Comprehensive Testing with pytest & Mocking Strategies",
        "duration": 40
      }
    ]
  },
  {
    ...
    "lectures": [
      {
        "id": "cpp-l1",
        "title": "Pointers, References & Memory Layout of Objects",
        "duration": 45
      },
      {
        "id": "cpp-l2",
        "title": "RAII and Smart Pointers: unique_ptr vs shared_ptr",
        "duration": 50
      },
      {
        "id": "cpp-l3",
        "title": "Move Semantics, Rvalue References & Rule of 5",
        "duration": 55
      },
      {
        "id": "cpp-l4",
        "title": "Standard Template Library (STL) Internals & Iterators",
        "duration": 50
      },
      {
        "id": "cpp-l5",
        "title": "C++ Concurrency: std::thread, Mutexes, and Condition Variables",
        "duration": 60
      }
    ]
  },
  ...
  },
  {
    ...
    "lectures": [
      ...
      {
        "id": "net-l3",
        "title": "DNS Resolution Hierarchy & Anycast Routing",
        "duration": 40
      },
      {
        "id": "net-l4",
        "title": "Transport Layer Security (TLS 1.3) Handshake & Encryption",
        "duration": 45
      },
      {
        "id": "net-l5",
  ...
  },
  {
    ...
    "lectures": [
      ...
      {
        "id": "ml-l4",
        "title": "Feature Scaling, Imputation & Cross-Validation Strategies",
        "duration": 40
      },
      {
        "id": "ml-l5",
  ...
  },
  {
    ...
    "lectures": [
      {
        "id": "genai-l1",
        "title": "Transformer Architecture & Foundation Model Capabilities",
        "duration": 40
      },
      {
        "id": "genai-l2",
        "title": "System Prompt Engineering, Few-Shot In-Context Learning",
        "duration": 45
      },
      {
        "id": "genai-l3",
      ...
      {
        "id": "genai-l4",
        "title": "Vector Embeddings, Cosine Similarity & Vector Databases",
        "duration": 45
      },
      {
        "id": "genai-l5",
        "title": "Tool / Function Calling & Autonomous Agent Loops",
        "duration": 50
      }
    ]
  },
  {
    ...
    "lectures": [
      {
        "id": "dsaip-l1",
        "title": "How FAANG Engineers Think: Clarifying Questions & Trade-Offs",
        "duration": 35
      },
      {
        "id": "dsaip-l2",
        "title": "Pattern 1-3: Sliding Window, Two Pointers & Fast/Slow Pointer",
        "duration": 60
      },
      {
        "id": "dsaip-l3",
        "title": "Pattern 4-6: Merge Intervals, Cyclic Sort & In-Place Reversal",
        "duration": 55
      },
      {
        "id": "dsaip-l4",
        "title": "Pattern 7-9: Two Heaps, Subsets & Modified Binary Search",
        "duration": 60
      },
      {
        "id": "dsaip-l5",
        "title": "Pattern 10-12: Top K Elements, K-way Merge & Knapsack DP",
        "duration": 65
      },
      {
        "id": "dsaip-l6",
        "title": "Mock Technical Interview Live Walkthrough & Clean Coding",
        "duration": 50
      }
    ]
  },
  {
    ...
    "lectures": [
      ...
      {
        "id": "sd-l4",
        "title": "Designing a Distributed Rate Limiter (Token Bucket / Sliding Log)",
        "duration": 55
      },
      {
        "id": "sd-l5",
        "title": "Designing a Scalable URL Shortener (TinyURL Architecture)",
        "duration": 50
      },
      {
        "id": "sd-l6",
        "title": "Designing a High-Scale News Feed Architecture (Fan-out on Read/Write)",
        "duration": 60
      }
    ]
  },
  {
    ...
    "lectures": [
      {
        "id": "beh-l1",
        "title": "The STAR Method (Situation, Task, Action, Result) Framework",
        "duration": 35
      },
      {
        "id": "beh-l2",
        "title": "Structuring High-Impact Stories: Failure, Disagreements & Ownership",
        "duration": 45
      },
      {
        "id": "beh-l3",
        "title": "Executive Presence, Confidence & Asking Strategic Interviewer Questions",
        "duration": 30
      }
    ]
  }
